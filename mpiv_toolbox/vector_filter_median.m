function[ uo, i_cond ] = vector_filter_median( ui, vec_std )
%========================================================================
%
% version 0.61
%
...
%
% Update:
%       0.62    2009/07/01 BSD License is applied
%       0.61    2003/07/02 Minor bug has been revised.
%       0.60    2003/06/26 Algorism has been revised.
...
for iy=1:my
   for ix=1:mx
      ...
      if abs( ui(ix,iy) - f_med ) > std_limit
         u(ix,iy) = NaN;
         i_cond = 1;
      end
   end
